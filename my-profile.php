                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="l-name" name="contact" value="<?=$data['contact']?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Address</label>
                            <div class="col-lg-10">
                              <textarea id="" class="form-control" cols="20" rows="5" name="add"><?=$data['address']?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
